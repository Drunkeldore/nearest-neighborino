...
del_truck_2 = DeliveryTruck(0.0, [3,18,36,38,6,25,28,32,2,4,5,7,8,9,10], "4001 South 700 East", datetime.timedelta(hours=9, minutes=5))
del_truck_3 = DeliveryTruck(0.0, [11,12,17,21,22,23,24,26,27,33,35,39], "4001 South 700 East", datetime.timedelta(hours=10, minutes=20))

#Calling algorithm for each truck
...
if __name__ == "__main__":
    ...
    while stop == False: # Looping until active is made false by user choice or program termination
        ...
        if user_choice == str(1):
            print(del_truck_1.miles + del_truck_2.miles + del_truck_3.miles)
